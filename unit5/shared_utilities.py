...
class LightningModel(L.LightningModule):
    def __init__(self, model, learning_rate):
        ...
        self.train_mse = torchmetrics.MeanSquaredError(task="multiclass", num_classes=10)
        self.val_mse = torchmetrics.MeanSquaredError(task="multiclass", num_classes=10)
        self.test_mse = torchmetrics.MeanSquaredError(task="multiclass", num_classes=10)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.val_mse(predicted_labels, true_labels)
