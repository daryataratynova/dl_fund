...
class LightningModel(L.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        #With weight_decay = 0.01 (or just Adam) test_acc = 0.8402500152587891
        #Using lower weight_decay returns lower test_acc, decided to increase it  
        #With weight_decay = 0.1 (or just Adam) test_acc = 0.8972499966621399    
